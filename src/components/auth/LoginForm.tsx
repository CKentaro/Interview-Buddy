...
import { LcArrowLeft, LcCheck, LcAlert, LcChevronDown, GoogleWhiteIcon } from "@/components/ui/icons";
        ...
        <div style={{ width: "min(420px, 100%)", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {state === "idle" && (
            <div className="card elev-md" style={{ padding: 24, gap: 16, animation: "ib-pop .35s ease both" }}>
              <button className="btn btn-primary" onClick={startAuth} style={{ width: "100%", justifyContent: "center", gap: 10, padding: 14, fontSize: 15 }}>
                <GoogleWhiteIcon size={18} />
